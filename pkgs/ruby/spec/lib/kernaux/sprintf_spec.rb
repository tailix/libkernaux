  ...
  if described_class.singleton_class.method_defined? :sprintf
    ...
    context 'using original tests' do
      [
        ...
        ['000000000000EDCB5433',   ['%020X', 3_989_525_555]],
        # padding .20
        ['00000000000000001024',   ['%.20d', 1024]],
        ['-00000000000000001024',  ['%.20d', -1024]],
        ['00000000000000001024',   ['%.20i', 1024]],
        ['-00000000000000001024',  ['%.20i', -1024]],
        ['00000000000000001024',   ['%.20u', 1024]],
        ['00000000004294966272',   ['%.20u', 4_294_966_272]],
        ['00000000000000000777',   ['%.20o', 511]],
        ['00000000037777777001',   ['%.20o', 4_294_966_785]],
        ['0000000000001234abcd',   ['%.20x', 305_441_741]],
        ['000000000000edcb5433',   ['%.20x', 3_989_525_555]],
        ['0000000000001234ABCD',   ['%.20X', 305_441_741]],
        ['000000000000EDCB5433',   ['%.20X', 3_989_525_555]],
