#ifndef KERNAUX_INCLUDED_EXTRAS_FONT8X16
#define KERNAUX_INCLUDED_EXTRAS_FONT8X16
...
typedef struct KernAux_FontCharMap
{
    unsigned char data[16];
} *KernAux_FontCharMap;

static const KernAux_FontCharMap KernAux_FontData8x16[256] = {
...
static inline KernAux_FontCharMap KernAux_get_font8x16_unicode(const char16_t _char)
{
    return KernAux_FontData8x16[_char];
}
