...
static mrb_value rb_KernAux_Version_enable_debugQN(mrb_state *mrb, mrb_value self);
...
void init_version(mrb_state *const mrb)
{
    ...
    mrb_define_class_method(mrb, rb_KernAux_Version, "enable_debug?",
                            rb_KernAux_Version_enable_debugQN, MRB_ARGS_REQ(0));
...
mrb_value rb_KernAux_Version_enable_debugQN(mrb_state *const mrb, const mrb_value self)
{
